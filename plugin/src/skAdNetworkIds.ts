// Auto-generated from yandex-mobile-ads@8.0.0 README.md (https://www.npmjs.com/package/yandex-mobile-ads)
// Includes Yandex Ads + all official mediation partners (AppLovin, AdMob, IronSource, Unity, Vungle, Mintegral, myTarget, Start.io) and their sub-adapters.
// Source of truth: regenerate by extracting <string>...skadnetwork</string> entries from the official package README on each SDK release.

export const DEFAULT_SKADNETWORK_IDS: readonly string[] = [
